    ...
    children: [
      ...
      { path: "reset-password", element: <ResetPasswordPage /> },
      {
        ...
        children: [
          ...
          { path: "desk/territory/*", element: <SellingModule /> },
          ...
          { path: "desk/bank/*", element: <AccountingModule /> },
          { path: "desk/bank-account/*", element: <AccountingModule /> },
          { path: "desk/bank-account-type/*", element: <AccountingModule /> },
          ...
          { path: "desk/pricing-rule", element: <SellingModule /> },
          { path: "desk/pricing-rule/*", element: <SellingModule /> },
          ...
          { path: "desk/system-settings", element: <SettingsModule /> },
          { path: "desk/system-settings/*", element: <SettingsModule /> },
          { path: "desk/global-defaults", element: <SettingsModule /> },
          { path: "desk/global-defaults/*", element: <SettingsModule /> },
