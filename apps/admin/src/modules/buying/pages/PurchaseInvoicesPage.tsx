...
export default function PurchaseInvoicesPage() {
  ...
  return <div className="mx-auto max-w-screen-2xl space-y-6 p-5 lg:p-8">
    <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
      <div><p className="text-sm font-semibold text-blue-600">Buying</p><h1 className="mt-1 text-3xl font-bold tracking-tight">Purchase Invoice</h1><p className="mt-2 text-sm text-slate-500">Catat tagihan supplier, pajak, pembayaran, dan nilai persediaan.</p></div>
      <Button asChild className="bg-blue-600 hover:bg-blue-700"><Link to="/desk/purchase-invoice/new"><FilePlus2 className="size-4" /> New Purchase Invoice</Link></Button>
    </header>
