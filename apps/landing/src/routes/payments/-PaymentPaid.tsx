    ...
    <div className="min-h-[90vh] bg-gray-50 flex flex-col items-center justify-center">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center border-t-4 border-green-500 animate-in zoom-in-95 duration-300">
        ...
        <p className="text-gray-600 mb-6 text-sm">
          Terima kasih telah mendaftar Codeverta LMS 2026.
          <br />
          E-Ticket telah dikirim ke email Penanggung Jawab.
        </p>
        <div className="bg-gray-50 p-4 rounded-lg mb-6 border border-gray-100">
          <p className="text-xs text-gray-500 uppercase tracking-wide mb-1">Total Dibayar</p>
          <p className="text-xl font-bold text-gray-900">
            {formatCurrency(
              paymentData?.final_amount + paymentData?.handling_fee + paymentData?.admin_fee,
            )}
          </p>
        </div>
        <button
